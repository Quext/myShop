<?php /* Smarty version Smarty-3.1.12, created on 2019-06-07 23:26:32
         compiled from "/Applications/MAMP/htdocs/myShop/themes/Backend/ExtJs/backend/index/controller/main.js" */ ?>
<?php /*%%SmartyHeaderCode:11268703065cfad688d804a2-75407591%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'a110245e5ec35359aeca0eaacb8d7a0dbf41fa6e' => 
    array (
      0 => '/Applications/MAMP/htdocs/myShop/themes/Backend/ExtJs/backend/index/controller/main.js',
      1 => 1559938522,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '11268703065cfad688d804a2-75407591',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5cfad688e89bb9_01132699',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5cfad688e89bb9_01132699')) {function content_5cfad688e89bb9_01132699($_smarty_tpl) {?>/**
 * Shopware 5
...
<?php $_tmp8=ob_get_clean();?><?php if ($_tmp8){?>*/
    ...
    checkLoginStatus: function () {
        Ext.TaskManager.start({
            ...
            run: function () {
                Ext.Ajax.request({
                    url: '<?php echo '/myShop/backend/login/getLoginStatus';?>',
                    success: function(response) {
                        var json = Ext.decode(response.responseText);

                        if(!json.success) {
                            window.location.href = '<?php echo '/myShop/backend';?>';
                        }
                    },
                    failure: function() {
                        window.location.href = '<?php echo '/myShop/backend';?>';
    ...
    checkBenchmarksStatus: function () {
        var interval = 10000,
            checkBenchmarksFn = function () {
                Ext.Ajax.request({
                    url: '<?php echo '/myShop/backend/benchmark/checkBenchmarks';?>',
                    success: function(response) {
