<?php /* Smarty version Smarty-3.1.12, created on 2019-06-07 23:26:31
         compiled from "/Applications/MAMP/htdocs/myShop/themes/Backend/ExtJs/backend/base/component/Shopware.form.field.TinyMCE.js" */ ?>
<?php /*%%SmartyHeaderCode:19935276815cfad6871d63f3-05285519%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '17acea9bbc18f04106f60bf8bf2726b5001783e1' => 
    array (
      0 => '/Applications/MAMP/htdocs/myShop/themes/Backend/ExtJs/backend/base/component/Shopware.form.field.TinyMCE.js',
      1 => 1559938522,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '19935276815cfad6871d63f3-05285519',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5cfad687230c64_41687382',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5cfad687230c64_41687382')) {function content_5cfad687230c64_41687382($_smarty_tpl) {?>/**
 * Shopware 5
...
",
            ...
            document_base_url: '<?php ob_start();?><?php echo 'http://localhost:8888/myShop/backend';?><?php $_tmp1=ob_get_clean();?><?php echo $_tmp1;?>
/'.replace('/backend', ''),

            // Content CSS - Styles the tiny mce editor. Please note the append timestamp. It's used to prevent caching the stylesheet
            contentCSS: 'http://localhost:8888/myShop/themes/Backend/ExtJs/backend/_resources/styles/tiny_mce.css?_dc=' + new Date().getTime(),
     ...
     */
    preloadImageUrl: '<?php echo '/myShop/backend/MediaManager/getMediaUrls';?>',
    ...
    replaceSmartyPluginWithImagePaths: function(rawContent) {
        ...
        Ext.each(images, function(img) {
            ...
            element.setAttribute('src', '/myShop/engine/Library/TinyMce/plugins/media_selection/assets/placeholder-image.png');
        });
