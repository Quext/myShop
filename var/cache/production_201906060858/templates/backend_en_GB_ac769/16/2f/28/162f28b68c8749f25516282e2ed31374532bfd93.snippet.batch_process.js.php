<?php /* Smarty version Smarty-3.1.12, created on 2019-06-07 23:26:35
         compiled from "/Applications/MAMP/htdocs/myShop/themes/Backend/ExtJs/backend/article_list/controller/batch_process.js" */ ?>
<?php /*%%SmartyHeaderCode:15821107785cfad68b13ed27-23799128%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '162f28b68c8749f25516282e2ed31374532bfd93' => 
    array (
      0 => '/Applications/MAMP/htdocs/myShop/themes/Backend/ExtJs/backend/article_list/controller/batch_process.js',
      1 => 1559938522,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '15821107785cfad68b13ed27-23799128',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.12',
  'unifunc' => 'content_5cfad68b2926b3_69949892',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5cfad68b2926b3_69949892')) {function content_5cfad68b2926b3_69949892($_smarty_tpl) {?>/**
 * Shopware 5
...
');
    ...
    addToQueue: function(config, offset, queueId, startTime) {
        ...
        Ext.Ajax.request({
            type: 'POST',
            url: '<?php echo '/myShop/backend/ArticleList/createQueue';?>',
            timeout: 4000000,
            params : {
                resource: 'product',
...
');
    ...
    runBatchProcess: function(queueId, config, startTime) {
        ...
        Ext.Ajax.request({
            url: '<?php echo '/myShop/backend/ArticleList/batch';?>',
            timeout: 4000000,
            params : {
                resource: 'product',
                limit: 200,
