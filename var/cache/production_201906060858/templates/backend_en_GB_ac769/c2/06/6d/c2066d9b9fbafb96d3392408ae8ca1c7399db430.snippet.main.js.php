<?php /* Smarty version Smarty-3.1.12, created on 2019-06-07 23:26:55
         compiled from "/Applications/MAMP/htdocs/myShop/engine/Shopware/Plugins/Default/Backend/PluginManager/Views/backend/plugin_manager/controller/main.js" */ ?>
<?php /*%%SmartyHeaderCode:16140361115cfad69fb1bd07-15877081%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'c2066d9b9fbafb96d3392408ae8ca1c7399db430' => 
    array (
      0 => '/Applications/MAMP/htdocs/myShop/engine/Shopware/Plugins/Default/Backend/PluginManager/Views/backend/plugin_manager/controller/main.js',
      1 => 1559938521,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '16140361115cfad69fb1bd07-15877081',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.12',
  'unifunc' => 'content_5cfad69fb6a186_38241765',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5cfad69fb6a186_38241765')) {function content_5cfad69fb6a186_38241765($_smarty_tpl) {?>
/**
 * Shopware 5
...
'
    ...
    init: function() {
        ...
        Ext.Ajax.request({
            url: '<?php echo '/myShop/backend/PluginManager/pingStore';?>',
            method: 'POST',
    ...
    installImportExportPlugin: function() {
        var me = this,
            plugin = Ext.create('Shopware.apps.PluginManager.model.Plugin', {
                ...
                iconPath: '/myShop/themes/Backend/ExtJs/backend/_resources/resources/themes/images/shopware-ui/importexport_plugin.png'
            });
...
'
    ...
    installMigrationPlugin: function() {
        var me = this,
            plugin = Ext.create('Shopware.apps.PluginManager.model.Plugin', {
                technicalName: 'SwagMigration',
                iconPath: '/myShop/themes/Backend/ExtJs/backend/_resources/resources/themes/images/shopware-ui/migration_plugin.png'
            });
